...
pub trait VirtualFs: Sync + Send {
    ...
    async fn link(&self, newparent: u64, newname: &str) -> AsyncFusexResult<()> {
        Err(AsyncFusexError::Unimplemented {
    ...
    #[allow(unused_variables)]
    async fn getxattr(&self, ino: u64, name: &str, size: u32) -> AsyncFusexResult<()> {
        Err(AsyncFusexError::Unimplemented {
    ...
    /// Get an extended attribute
    #[allow(unused_variables)]
    async fn listxattr(&self, ino: u64, size: u32) -> AsyncFusexResult<()> {
        Err(AsyncFusexError::Unimplemented {
